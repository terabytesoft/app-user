...
return [
    ...
    'user.setting.theme' => true,
    'user.setting.theme.view.security.login' => '@TerabyteSoft/Themes/Adminator/Views/Theme/Pages.php',
    'user.setting.theme.view.registration.register' => '@TerabyteSoft/Themes/Adminator/Views/Theme/Pages.php',
    'user.setting.theme.view.registration.request' => '@TerabyteSoft/Themes/Adminator/Views/Theme/Pages.php',
    'user.setting.theme.view.registration.resend' => '@TerabyteSoft/Themes/Adminator/Views/Theme/Pages.php',
